...
- 🚧 **v1.0.3 JSON 저장 결함 수정 (KTC 2차)** — Phase 7 (active, started 2026-05-06)
- 📋 **v1.x / next** — Planned (DOC-01/02/03 + USAB-05 + AVI cold-start 등)
...
- [ ] Success criteria:
  ...
  3. 회귀: v1.0.2 에서 통과한 JSON 저장 시나리오 (타임스탬프, 카테고리 매핑, BBOX ≥ 2개 정상 케이스) 미회귀
  4. v1.0.3 인스톨러 빌드 성공 + 1.0.2 → 1.0.3 in-place 업그레이드 검증 통과
...
| v1.0.3 JSON 저장 결함수정 (KTC 2차) | Phase 7 (2/3 plans) | 🚧 Executing | 2026-05-06 |

...
**Shipped:** v1.0.3 (2026-05-06) — ASLT-Setup-v1.0.3.exe (98.19 MB, SHA256 `9ECAF3C3...`)
...
| 3차 빌드 cycle (UAT 도중 popup + retention 변경) | 사용자 흐름 개선 사항을 별도 milestone 으로 미루지 않고 v1.0.3 동일 binary 통합 | ⚠ Revisit — 향후 milestone 에서 UAT 진입 전 source freeze 정책 명시 필요 |
...
---
*Last updated: 2026-05-06 after v1.0.3 milestone — JSON 저장 결함 수정 (KTC 2차) shipped, ASLT-Setup-v1.0.3.exe production-ready*

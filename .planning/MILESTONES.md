...
5. **사용자 흐름 개선 (out-of-scope but in-binary)** — 정보 팝업 Entry/Exit Shift 변형 표기 (commit `8a22445`), 로그 보존 30일 → 180일 (commit `df890bd`)
...
- 3차 빌드 cycle (UAT 도중 popup fix + retention 변경) — 향후 milestone 에서 UAT 단계 진입 전 source freeze 정책 명시 필요
